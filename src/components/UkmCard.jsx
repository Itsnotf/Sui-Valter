...
function UkmCard() {
    ...
    return (
        <div className='w-full  flex justify-center mt-[100px] '>
            <div className='flex flex-row gap-[40px] mr-[38px]' >
                <div className='flex flex-col gap-[27px] mr-50' data-aos="fade-right">
                ...
                <div className='w-[536px] h-[542px] bg-[#393E4680] rounded-[20px]' data-aos="fade-left" >
